      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-muted-foreground mt-1">
            Full admin control to view registered members, assign roles (ADMIN, SHIFTER, MEMBER), onboard offline records, and manage validity.
          </p>
        </div>
                ...
                {filtered.map((u) => {
                  ...
                  return (
                    <tr key={String(u.id)} className="hover:bg-muted/30 transition-colors">
                      ...
                      {/* Role (Editable without Super Admin) */}
                      <td className="px-4 py-3.5">
                        {u.role === "SUPER_ADMIN" ? (
                          <div className="space-y-0.5">
                        ...
                        <div className="flex items-center justify-end gap-1.5">
                          ...
                          {u.role !== "SUPER_ADMIN" && (
                            <button
                              ...
                              title="Delete Member (Super Admin / Admin Full Power)"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-xs">
          <div className="rounded-xl border border-emerald-300/40 bg-emerald-500/5 p-3 space-y-1">
            <p className="font-bold text-emerald-900 dark:text-emerald-300 flex items-center gap-1.5">
              ...
              Role Modification & Full Power
            </p>
            <p className="text-[11px] text-muted-foreground leading-relaxed">
              Admins and Super Admins can promote or switch user roles, delete accounts, or dispatch pre-deletion notices to inactive or expired members.
            </p>
          </div>
          <div className="rounded-xl border border-blue-300/40 bg-blue-500/5 p-3 space-y-1">
            ...
            <p className="text-[11px] text-muted-foreground leading-relaxed">
              Register walk-in members or onboard offline legacy members with custom start and expiration validity dates.
            </p>
          </div>
          <div className="rounded-xl border border-amber-300/40 bg-amber-500/5 p-3 space-y-1">
            <p className="font-bold text-amber-900 dark:text-amber-300 flex items-center gap-1.5">
              ...
              Cash & Validity Verification
            </p>
            <p className="text-[11px] text-muted-foreground leading-relaxed">
              Approve cash membership subscriptions and extend or customize membership expiration directly from this table.
            </p>
          </div>
        </div>
      </div>
