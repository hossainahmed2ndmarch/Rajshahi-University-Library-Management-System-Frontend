...
export function PublicationsManagement({
  ...
  const { data: articlesData, isLoading } = useGetArticles({
    isPublished: "ALL", // Fetch both drafts and published for staff dashboard
    limit: 100,
  });
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <div className="flex items-center gap-2">
            ...
            {roleBadge && (
              <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[10px] font-bold bg-[#C78700]/15 text-[#C78700] border border-[#C78700]/30 font-mono uppercase">
