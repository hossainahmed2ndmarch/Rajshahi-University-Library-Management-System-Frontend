      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-muted-foreground mt-1">
            Approve pending member requests (with auto due-dates at 15
            pages/day), process returns, and manage circulation.
          </p>
        </div>
        ...
        >
          <Send
            className={`h-3.5 w-3.5 ${isCheckingOverdue ? "animate-spin" : ""}`}
          />
          <span>
            {isCheckingOverdue ? "Auditing..." : "Audit Overdue Borrows"}
          </span>
        </button>
      </div>
                      ...
                      >
                        ...
                        <td className="px-4 py-4 max-w-[220px]">
                          ...
                          <p className="text-[11px] text-muted-foreground">
                            {pages} Pages ({calculatedDays} days rate)
                          </p>
                          {b.book?.locationCell && (
            ...
            <div className="space-y-2 text-xs">
              ...
              {calcDaysOverdue(selectedBorrowForReturn.dueDate) > 0 && (
                <p className="text-red-600 font-bold">
                  ...
                  (Suggested fine: ৳
                  {calcDaysOverdue(selectedBorrowForReturn.dueDate) *
                    FINE_PER_DAY}
                  )
                </p>
              )}
